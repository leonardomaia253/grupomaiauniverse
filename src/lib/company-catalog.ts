...
export const INSTITUTIONAL_COMPANIES: InstitutionalCompany[] = [
  ...
  { slug: "abroo", name: "Abroo", sector: "Plataforma Digital", description: "Estrutura modular para novas frentes de produto e serviço.", repository: "https://github.com/leonardomaia253/volup-plateforme-gastronomique" },
  ...
  { slug: "boase", name: "Boase", sector: "Operação & Serv.", description: "Serviços orientados à consistência, conexão e execução.", repository: "https://github.com/leonardomaia253/boase-" },
  ...
  { slug: "grupo-maia", name: "Grupo Maia", sector: "Holding", description: "Governança, capital e capacidades compartilhadas para todo o ecossistema.", repository: "https://github.com/leonardomaia253/holding-insight-hub" },
  ...
  { slug: "iris", name: "Iris", sector: "IA & Automação", description: "Tecnologia de leitura, percepção e clareza operacional.", repository: "https://github.com/leonardomaia253/auto-law-orchestra-" },
  ...
  { slug: "maia-go", name: "Maia Go", sector: "Mobilidade", description: "Mobilidade, execução e conexão entre operações.", repository: "https://github.com/leonardomaia253/maia-smart-market" },
  { slug: "minvest", name: "Minvest", sector: "Investimentos", description: "Inteligência de capital e perspectiva patrimonial de longo prazo.", repository: "https://github.com/leonardomaia253/minvest-accelerate" },
  ...
  { slug: "the-maia", name: "The Maia", sector: "Holding", description: "Marca e identidade institucional do ecossistema.", repository: "https://github.com/leonardomaia253/themaiax" },
  ...
  { slug: "volup-ai", name: "Volup AI", sector: "IA & Automação", description: "Inteligência aplicada a produtos, operações e novas capacidades.", repository: "https://github.com/leonardomaia253/volup-ai-solutions" },
];
