...
export const DEFAULT_SKY_ADS: SkyAd[] = [
  {
    ...
    brand: "Git Universe",
    description: "A Universe built from GitHub contributions. Search your username and find your planet among thousands of companies.",
    color: "#f8d880",
    bgColor: "#1a1018",
    link: "https://thegitUniverse.com",
    vehicle: "plane",
    priority: 100,
  },
  {
    ...
    brand: "Sky Ads",
    description: "Want your brand flying over Git Universe? Planes, blimps, your colors. Get in touch!",
    color: "#f8d880",
    bgColor: "#1a1018",
    link: "https://thegitUniverse.com/advertise",
    vehicle: "plane",
    priority: 10,
  },
];
