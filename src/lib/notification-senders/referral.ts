...
export function sendReferralJoinedNotification(
  ...
  sendNotificationAsync({
    ...
    title: `Your referral @${referredLogin} just joined Grupo LMF Universe!`,
    body: `@${referredLogin} joined Grupo LMF Universe through your referral link.`,
    html: `
      ...
      <h1 style="margin:0 0 8px; font-size:24px; font-weight:bold; color:#111111; font-family:Helvetica,Arial,sans-serif;">@${referredLogin} is in Grupo LMF Universe!</h1>
