...
export function sendWelcomeNotification(devId: number, login: string, rank?: number) {
  ...
  sendNotificationAsync({
    ...
    title: `Bem-vindo ao Mapa Vivo, @${login}!`,
    body: `Seu planeta esta disponivel no Mapa Vivo. ${rankText} Check in daily to grow your streak and unlock items.`,
    html: `
      ...
      <p style="margin:0 0 20px; font-size:15px; color:#555555; line-height:1.6;">Mapa Vivo e um guia visual construido para apresentar empresas, historias e informacoes publicas. Here's how to get started:</p>
