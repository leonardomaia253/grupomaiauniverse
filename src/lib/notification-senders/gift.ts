...
export function sendGiftReceivedNotification(
  ...
  sendNotificationAsync({
    ...
    body: `@${giverLogin} sent you ${itemName}. It's now on your planet!`,
    html: `
      ...
      <p style="margin:0 0 28px; font-size:15px; color:#555555; line-height:1.6;"><strong>@${giverLogin}</strong> gifted this to you. It's now equipped on your planet!</p>
      <hr style="border:none; border-top:1px solid #eeeeee; margin:0 0 28px;" />
      ${buildButton("Check Your planet", `${BASE_URL}/?user=${receiverLogin}`)}
    `,
