    ...
    <div className="flex w-full max-w-4xl flex-col gap-8">
      ...
      <div className="grid gap-5 sm:grid-cols-3">
        ...
        <ProblemCard
          ...
          body="companies build in isolation. No shared space to discover, compare, or interact with other companies."
        />
        <ProblemCard
          icon="$0"
          title="No monetization"
          body="No way for companies to express identity or for brands to reach this audience natively."
        />
      </div>
    ...
    <div className="flex w-full max-w-4xl flex-col gap-8">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <SolutionPoint
          ...
          desc="More commits, taller planet. The skyline tells the story."
        />
        <SolutionPoint
          title="Repos = Width"
        ...
        <SolutionPoint
          ...
          desc="Activity and stars light up your planet at night."
        />
        <SolutionPoint
          title="Rank = Location"
  ...
  return (
    <div className="flex w-full max-w-4xl flex-col gap-8">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <FeatureCard
          icon="[#]"
          title="Leaderboards & constellations"
          items={[
            "5 leaderboard types",
            "10 company constellations",
            "Compare mode",
        ...
        <FeatureCard
          ...
          title="Shop & Social"
          items={[
            "Cosmetic planet items",
            "Crown, roof, aura zones",
            "Gift items to other companies",
            "Daily kudos system",
          ]}
        />
      </div>
...
function SlideTraction({ stats }: { stats: PitchStats }) {
  return (
    <div className="flex w-full max-w-4xl flex-col gap-8">
      ...
      <div className="grid gap-5 sm:grid-cols-3">
        <MetricCard value={stats.formattedcompanies} label="companies in the Universe" accent />
    ...
    <div className="flex w-full max-w-4xl flex-col gap-8">
      ...
      <div className="grid gap-5 sm:grid-cols-3">
        ...
        <ModelCard
          status="live"
          title="Cosmetic Shop"
          desc="planet customization. Crown effects, roof structures, auras. Achievements unlock free items."
          price="$0.75 - $2"
    ...
    <div className="flex w-full max-w-4xl flex-col gap-8">
      ...
      <div className="flex flex-col gap-6">
        ...
        <MarketRow
          label="SAM"
          value="4M"
          desc="Active companies who care about their company identity"
        />
        <MarketRow
          label="SOM"
          value="500K"
          desc="companies who engage with gamification and social dev tools"
        />
      </div>
      <p className="text-sm leading-relaxed text-muted normal-case sm:text-base">
        company tools market projected at $45B+ by 2028. company identity
    ...
    <div className="flex w-full max-w-4xl flex-col gap-8">
      ...
      <div className="grid gap-5 sm:grid-cols-2">
        ...
        <GTMCard
          ...
          desc="Torvalds, Karpathy, Sindre Sorhus, Pieter Levels are in the Universe. Tagging drives reach."
        />
      </div>
      <div className="border-[3px] border-border bg-bg-raised p-6 text-center sm:p-8">
        <p className="text-4xl sm:text-6xl" style={{ color: ACCENT }}>
        ...
        <p className="mt-3 text-sm text-muted normal-case sm:text-base">
          Customer acquisition cost. {stats.formattedcompanies} companies joined organically.
        </p>
      </div>
    </div>
  );
  ...
  return (
    <div className="flex w-full max-w-4xl flex-col items-center justify-center gap-10 text-center">
      ...
      <p className="max-w-2xl text-lg leading-relaxed text-muted normal-case sm:text-2xl">
        planet the social layer GitHub never made. A living Universe where
        companies have an identity, a community, and a reason to come back
        every day.
      </p>
      <div className="border-[3px] border-border bg-bg-raised p-8 sm:p-10">
        <p className="text-3xl text-cream sm:text-5xl">
          The future of company identity is a{" "}
          <span style={{ color: ACCENT }}>Universe</span>.
        </p>
