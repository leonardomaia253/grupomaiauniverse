...
export const alt = "Grupo LMF Universe - Suas empresas como um Universo 3D";
...
export default async function Image() {
  ...
  // Skyline planets — max height 180px so they never overlap the title zone
  const GROUND_Y = 500;
  const planets = [
    { x: 50, w: 100, h: 130 },
    { x: 158, w: 80, h: 80 },
  ...
  return new ImageResponse(
    (
      ...
      >
        {/* Title — positioned above planets with z layering */}
        <div
          style={{
            position: "absolute",
            top: 0,
        ...
        >
          ...
          >
            <span style={{ fontSize: 110, color: cream }}>GRUPO</span>
