    ...
    <main className="min-h-screen bg-bg font-pixel uppercase text-warm">
      <div className="mx-auto max-w-3xl px-4 py-10">
        ...
        <p className="mt-2 text-xs text-muted normal-case sm:text-sm">
          50,000 planets. 2 million views. Zero ads. Built by one dev, on nights and weekends.
          Here&apos;s how you can help keep this Universe growing.
        </p>
        ...
        {thanks && (
          ...
          >
            ...
            <p className="mt-2 text-xs text-muted normal-case">
              Your contribution keeps the Universe running. You are a real one.
            </p>
          </div>
        )}
