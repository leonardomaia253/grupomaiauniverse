    ...
    switch (paymentStatus) {
      ...
      case "confirmed": {
        ...
        const { data: purchase } = await sb
          .from("purchases")
          .select("id, status, company_id, item_id, gifted_to")
        ...
        if (purchase.item_id === "streak_freeze") {
          await sb.rpc("grant_streak_freeze", { p_company_id: purchase.company_id });
        ...
        const ownerId = purchase.gifted_to ?? purchase.company_id;
