      ...
      case "checkout.session.completed": {
        ...
        if (pending) {
          ...
          if (itemId === "streak_freeze") {
            await sb.rpc("grant_streak_freeze", { p_company_id: Number(companyId) });
          ...
          const ownerId = giftedTo ? Number(giftedTo) : Number(companyId);
          ...
          if (!existing) {
            ...
            await autoEquipIfSolo(Number(companyId), itemId);
          }
        }
        break;
      }
