...
export const metadata: Metadata = {
  title: "Privacy Policy - Constellation OS",
  description: "Privacy Policy for Constellation OS.",
};
        ...
        <div className="mt-8 flex flex-col gap-5">
          ...
          <Section n={2} title="How We Use Your Data">
            <ul className="flex flex-col gap-1">
              <Li>Generate your 3D planet in the Universe</Li>
          ...
          <Section n={4} title="Cookies & Local Storage">
            <p>
              ...
              user preferences (theme, constellation selection). We use Vercel
          ...
          <Section n={7} title="Security">
            <p>
              ...
              authentication through autenticacao segura. However, no system is 100%
              secure.
            </p>
          </Section>
          ...
          <Section n={8} title="Children">
            <p>
              Constellation OS is not intended for children under 13. We do not knowingly
          ...
          <Section n={9} title="Changes">
            <p>
              We may update this policy at any time. Continued use of Constellation OS
