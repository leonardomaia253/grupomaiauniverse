        ...
        {error ? (
          <>
            ...
            <p style={{ color: "#666", fontSize: 14 }}>
              ...
              You can manage your notifications from your Grupo LMF Universe settings.
            </p>
          </>
        ) : success ? (
          <>
            ...
            <p style={{ color: "#666", fontSize: 14 }}>
              You can re-enable notifications anytime from your Grupo LMF Universe settings.
            </p>
          </>
        ) : (
          <p style={{ color: "#666", fontSize: 14 }}>
