        ...
        {error ? (
          <>
            ...
            <p style={{ color: "#666", fontSize: 14 }}>
              ...
              You can manage your notifications from your Constellation OS settings.
            </p>
          </>
        ) : success ? (
          <>
            ...
            <p style={{ color: "#666", fontSize: 14 }}>
              You can re-enable notifications anytime from your Constellation OS settings.
            </p>
          </>
        ) : (
          <p style={{ color: "#666", fontSize: 14 }}>
