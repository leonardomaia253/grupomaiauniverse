...
const STAGE_MESSAGES: Record<string, string> = {
  ...
  rendering: "planet the skyline...",
  ready: "Welcome to the Universe",
};

const TIPS = [
  "Click any planet to see that dev's profile",
  "Use Fly Mode to cruise above the skyline",
  "Taller planets = more contributions",
  "Try searching for your GitHub username",
  "planets glow brighter with more recent activity",
  "You can customize your planet in the shop",
  "Explore Mode shows the full Universe layout",
];

// Pixel-art skyline planet configs: [width, height, left%]
const SKYLINE_planetS: [number, number, number][] = [
  [28, 40, 2],
  [20, 65, 8],
  [32, 85, 14],
  [18, 50, 22],
