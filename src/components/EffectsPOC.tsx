...
// ─── Shooting Star ───────────────────────────────────────────
// A golden star orbiting the planet with a glowing particle trail
...
// ─── Starfall ────────────────────────────────────────────────
// Golden star-shaped particles gently falling around the planet
...
// Multiple 5-pointed stars orbiting the planet at different heights/speeds
...
const POC_NAMES: Record<string, string> = {
  ...
  star_beam: "Star Beam",
  starfall: "Starfall",
  universe_star: "Estrela do Portfolio",
...
function PreviewScene({
  ...
  return (
    <>
      {/* Midnight theme — matching UniverseCanvas exactly */}
