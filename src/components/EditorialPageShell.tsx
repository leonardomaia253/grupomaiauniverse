...
export default function EditorialPageShell({
  ...
  return (
    <main className="maia-editorial-shell relative min-h-screen overflow-hidden bg-[#12110f] text-[#eee9df]">
      <a className="maia-skip-link" href="#conteudo">Ir para o conteúdo</a>
      <header className="maia-editorial-header relative z-20 border-b border-white/10 bg-[#12110f]/90">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-5 sm:px-8 lg:px-12">
          <Link href="/" className="maia-wordmark" aria-label="Grupo Maia — início"><span>MAIA</span><small>Grupo</small></Link>
          <nav className="maia-editorial-nav flex items-center gap-5 text-[11px] text-white/55" aria-label="Navegação principal">
            <Link href="/">Empresas</Link>
            <Link href="/intro">Apresentação</Link>
            <Link className="hidden sm:block" href="/support">Contato</Link>
          </nav>
        </div>
      </header>
      <div id="conteudo" className={`relative z-10 mx-auto ${wide ? "max-w-7xl" : "max-w-4xl"} px-5 pb-24 pt-14 sm:px-8 sm:pt-20 lg:px-12`}>
        <div className="maia-editorial-heading max-w-3xl">
        ...
        <div className="maia-editorial-content mt-14">{children}</div>
      </div>
