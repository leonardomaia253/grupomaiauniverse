    ...
    <main className="min-h-screen bg-[#12110f] text-[#eee9df]">
      <header className="border-b border-white/12">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-5 sm:px-8 lg:px-12">
          ...
          <nav className="flex items-center gap-5 text-xs text-white/55" aria-label="Navegação principal">
      ...
      <div className={`mx-auto ${wide ? "max-w-7xl" : "max-w-4xl"} px-5 pb-24 pt-14 sm:px-8 sm:pt-20 lg:px-12`}>
        <div className="max-w-3xl">
          ...
          <h1 className="mt-4 text-5xl font-normal leading-[.94] tracking-[-.055em] text-[#f2eee6] sm:text-7xl">{title}</h1>
