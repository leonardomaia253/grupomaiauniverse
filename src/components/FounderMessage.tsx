...
const MESSAGES: Record<Lang, string[]> = {
  en: [
    ...
    "Behind every planet you see, there's a real commit. Behind every lit window, a real dev. I built this to make the invisible visible. One dev, a few weekends, and a signal that reached over two million people in two weeks. Fifty thousand planets. Zero ads. Just companies finding their Universe and passing the signal forward.",
    "Transmitting costs something. Servers, database, API calls. Every planet that goes up, the cost goes up with it. Right now, I'm the one keeping this antenna on.",
    "If this Universe means something to you, help me keep the signal alive.",
  ],
  pt: [
