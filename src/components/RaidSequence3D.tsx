  ...
  useFrame((_, delta) => {
    ...
    switch (phase) {
      ...
      case "attack": {
        ...
        // Camera distance: wide enough to see over neighboring planets
        const camDist = ORBIT_RADIUS * 1.5;

        // Camera height: above planet top to clear skyline, cinematic angle ~20-25°
        ...
        // LookAt: always toward defender planet (slight vehicle blend early on)
