...
// ─── Neon Outline ────────────────────────────────────────────
// Wireframe edges with strong emission around the planet
...
// Each purchase = one billboard slot distributed across planet faces
...
// ─── Flag ────────────────────────────────────────────────────
// Animated flag on corner of planet (front-right)
...
// ─── Neon Trim (aura zone) ───────────────────────────────────
// Glowing neon outlines on all 12 planet edges + scanning band
...
// Wireframe force field wrapping planet + 2 orbiting data rings
...
export const HologramRing = memo(function HologramRing({
  ...
  // Shield must enclose the planet — use diagonal + padding
...
// Scrolling marquee segments around planet — Times Square style
...
// ─── Streak Glow ──────────────────────────────────────────
// Vertical neon strips on planet edges. Height scales with streak.
...
// Applied based on company XP tier to show progression
...
/** Production tier (Lv 9-13): Pulsating glow at planet base */
