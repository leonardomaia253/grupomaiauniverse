...
BEGIN
  ...
  -- Level never drops
  UPDATE companies SET xp_level = GREATEST(xp_level, v_new_level)
  WHERE id = p_company_id;

  -- Audit log
  INSERT INTO xp_log (company_id, source, amount)
  VALUES (p_company_id, p_source, v_actual);
...
DECLARE
  ...
  v_level integer;
BEGIN
  FOR r IN SELECT * FROM companies LOOP
