...
CREATE INDEX IF NOT EXISTS idx_companies_vscode_api_key_hash
  ON companies(vscode_api_key_hash) WHERE vscode_api_key_hash IS NOT NULL;
...
-- 2. Restrict RLS on company_sessions (M3)
...
CREATE POLICY "No direct public read" ON company_sessions
